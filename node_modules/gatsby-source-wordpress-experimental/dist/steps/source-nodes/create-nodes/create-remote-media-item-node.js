...
const errorPanicker = ({
  ...
  if (process.env.NODE_ENV !== `production` && errorString.includes(`Response code 404`)) {
  ...
  if (errorString.includes(`Response code 4`) || errorString.includes(`Response code 500`) || errorString.includes(`Response code 511`) || errorString.includes(`Response code 508`) || errorString.includes(`Response code 505`) || errorString.includes(`Response code 501`)) {
    reporter.log(``);
